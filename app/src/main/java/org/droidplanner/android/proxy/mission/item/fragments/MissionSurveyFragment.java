...
public class MissionSurveyFragment<T extends Survey> extends MissionDetailFragment implements
    ...
    public void onApiConnected() {
        ...
        mAltitudePicker = (CardWheelHorizontalView) view.findViewById(id.altitudePicker);
    ...
    public void onScrollingEnded(CardWheelHorizontalView cardWheel, Object startValue, Object endValue) {
        switch (cardWheel.getId()) {
            case id.anglePicker:
            case id.altitudePicker:
            case id.overlapPicker:
            case id.sidelapPicker:
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if(!surveyList.isEmpty()) {
            ...
            for(T survey : surveyList) {
                switch(viewId) {
                    case id.check_start_camera_before_first_waypoint:
