...
public class UploaderService extends IntentService {
    ...
    String CHANNEL_ONE_ID = "org.droidplanner.android.one";
    String CHANNEL_TWO_ID = "org.droidplanner.android.two";
    String CHANNEL_THREE_ID = "org.droidplanner.android.three";
    ...
    private void onUploadFailure(Exception ex) {
        ...
        if (failedUploadNotification == null) {
            failedUploadNotification = generateNotificationBuilder().setContentText(msg).setChannelId(CHANNEL_THREE_ID)
