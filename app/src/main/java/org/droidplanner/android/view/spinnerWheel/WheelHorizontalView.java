...
public class WheelHorizontalView<T> extends AbstractWheelView {
	...
	protected void measureLayout() {
		...
		// XXX: Locating bug
		mItemsLayout.measure(MeasureSpec.makeMeasureSpec(getWidth() + getItemDimension(),
				MeasureSpec.UNSPECIFIED), MeasureSpec.makeMeasureSpec(getHeight(),
				MeasureSpec.AT_MOST));
	}
	...
	private int calculateLayoutHeight(int heightSize, int mode) {
		mItemsLayout.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT));
		mItemsLayout.measure(MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED),
		...
		// MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED),
				MeasureSpec.makeMeasureSpec(400, MeasureSpec.EXACTLY), MeasureSpec
						.makeMeasureSpec(height - 2 * mItemsPadding, MeasureSpec.EXACTLY));
